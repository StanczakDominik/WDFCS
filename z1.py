...
plt.plot(temperature_celsius, HF_mW, "-")
# plt.plot(temperature_celsius, heat_flow_gradient, "r-")
plt.grid(True)

for i, j, k, l in ((300, 430, 300, 490),(490,495, 300, 550), (500, 520, 480, 535), (580, 600, 540, 780), (743,780,608,780)):
